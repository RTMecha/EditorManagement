...
{
    [BepInPlugin("com.mecha.editormanagement", "EditorManagement", "2.5.14")]
    public class EditorPlugin : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            try
            {
                ...
                var jn = SimpleJSON.JSON.Parse(RTFile.ReadFromFile(RTFile.ApplicationDirectory + "BepInEx/plugins/Assets/editor_themes.lst"));
            ...
            {
                Logger.LogError($"Failed to initialize editor themes.\nException: {ex}");
                throw;
            }
        ...
        public static void SetPreviewConfig()
        {
            try
            {
                ...
                RTObject.CreateKeyframe = EditorConfig.ObjectDraggerCreatesKeyframe.Value;
